...
public class ScriptTemplate {
    ...
    public static String staticInsert = "  begin\n"
            ...
            + "       where S_NAME_USER_EXIT = NVL(v_s_user_exit_name,upper(v_s_script_name) || '_EXIT');\n"
            + "      --\n"
            ...
            + "             N_ORDER           = v_n_order,\n"
            + "             ID_SCRIPT_EDITOR  = v_n_id_script_editor\n"
            + "       where ID_USER_EXIT = v_n_id_user_exit;\n"
            + "    when others then\n"
            + "      null;\n"
            + "  end;\n";
    public static String footerData = "  begin\n"
            ...
            + "        (SELECT ID_SCRIPT_EDITOR_CST FROM &&TAXIT_USER..FMK_SCRIPT_EDITOR_CST WHERE ID_SCRIPT_EDITOR = v_n_id_script_editor),\n"
